...
function endElement(name) {
    if (currentObject != undefined && currentObject[textNodeName()]) {
        if (options.trim) {
    ...
    if (currentObject != undefined && currentElementName !== name) {
    ...
    if (!options.reversible) {
        if (currentObject != undefined && (textNodeName() in currentObject) && (Object.keys(currentObject).length == 1)) {
